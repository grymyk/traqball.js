...
const Traqball = () => {
	...
	function getStyle(target, prop){
		let style = document.defaultView.getComputedStyle(target, "");
	...
	Traqball.prototype.setup = function(conf){
		...
		(function init (){
			...
			impulse = THIS.config.impulse !== false;
			...
			let perspective = getStyle(stage, prefix+"perspective");
			let pOrigin     = getStyle(stage, prefix+"perspective-origin");
			let bTransform  = getStyle(THIS.box, prefix+"transform");
...
const TraqballMock = () => {
    return <div>'Hello From traqball component!'</div>
};

export default TraqballMock;
